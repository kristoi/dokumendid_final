...
<div id="list-document" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="created_by"
                              title="${message(code: 'document.created_by.label', default: 'Createdby')}"/>

            <g:sortableColumn property="updated_by"
                              title="${message(code: 'document.updated_by.label', default: 'Updatedby')}"/>

            <g:sortableColumn property="dateCreated"
                              title="${message(code: 'document.dateCreated.label', default: 'Date Created')}"/>

            <g:sortableColumn property="description"
                              title="${message(code: 'document.description.label', default: 'Description')}"/>
            ...
            <g:sortableColumn property="filename"
                              title="${message(code: 'document.filename.label', default: 'Filename')}"/>
